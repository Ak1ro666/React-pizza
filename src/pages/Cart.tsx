...
const Cart = () => {
	...
	const orderCount = useSelector((state: any) =>
		state.cart.items.reduce((sum: number, item: IItem) => sum + item.count, 0),
	);

	const onClearItems = () => {
		if (window.confirm('Ты действительно хочешь удалить все из корзины?')) {
			dispatch(clearItems());
		}
	};
							...
							<div className='cart'>
								...
								<div className='cart__bottom'>
									...
									<div className='cart__bottom-buttons'>
										<Link
											to={'/'}
											className='button button--outline button--add go-back-btn button-hover'>
											<svg
												width='8'
												height='14'
												viewBox='0 0 8 14'
